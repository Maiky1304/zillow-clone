...
import ApplicationMark from '@/Components/Dashboard/ApplicationMark';
import Banner from '@/Components/Dashboard/Banner';
import Dropdown from '@/Components/Dashboard/Dropdown';
import DropdownLink from '@/Components/Dashboard/DropdownLink';
                            ...
                            <div className="flex">
                                ...
                                <div className="flex-shrink-0 flex items-center">
                                    <InertiaLink href={route('dashboard')}>
                                        <ApplicationMark className="h-7 w-30" />
                                    </InertiaLink>
                                </div>
                                ...
                                <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                    ...
                                    <NavLink
                                        href={route('real-estate')}
                                        active={route().current('real-estate')}
                                    >
                                        Real Estate
                                    </NavLink>
                                </div>
