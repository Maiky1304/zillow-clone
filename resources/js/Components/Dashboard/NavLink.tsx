...
export default function NavLink({
  ...
  const classes = active
    ? 'inline-flex items-center px-1 pt-1 border-b-2 border-zillow-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-zillow-700 transition'
